    ...
    try {
      ...
      if (formData.newPassword !== "" && formData.confirmPassword !== "") {
        ...
        try {
          ...
          setError({ ...initialErr, form: "Failed to update password!" });
          setIsLoading(false);
          return;
        }
      }
      ...
      const resultData = result.data.metadata[1][0];
      ...
      const image = resultData.avatar_url;
                ...
                <div className="px-8 py-14">
                  ...
                  <div className="flex flex-col md:flex-row w-full justify-between mt-12">
                    <div className="relative mb-8 md:mb-0">
                      <label htmlFor="oldPassword" className="flex mb-3">
                        Old Password
                      </label>
                      <input
                        ...
                        className={` w-full md:w-[18rem] lg:w-[20rem] h-16 border outline-none py-5 px-6 rounded focus:border-primary ${
                          error.oldPasword && "border-error"
                        }`}
                      />
                      <i
                        className={`bi ${
                          showOld ? "bi-eye" : "bi-eye-slash"
                        } absolute right-4 bottom-5 `}
                        onClick={handleShowOld}
                      ></i>
                    </div>
                  </div>
                  <div className="flex flex-col md:flex-row w-full justify-between mt-8">
                    <div className="relative mb-8 md:mb-0">
